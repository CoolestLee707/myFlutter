          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              UserAccountsDrawerHeader(
                ...
                accountEmail: Text('Emile',style: TextStyle(color: Colors.yellow),),
              ...
              ListTile(
                ...
                trailing: Icon(Icons.system_update,color: Colors.red,size: 30.0,),
                onTap: () => Navigator.pop(context),
              ),
              ListTile(
                leading: Icon(Icons.supervised_user_circle),
                title: Text('secoond select',textAlign: TextAlign.center,),
                trailing: Icon(Icons.supervised_user_circle,color: Colors.green,size: 30.0,),
                onLongPress: () => Navigator.pop(context),
              ),
              ListTile(
                leading: Icon(Icons.settings_system_daydream),
                title: Text('state_management',textAlign: TextAlign.center,),
                trailing: Icon(Icons.settings_system_daydream,color: Colors.blue,size: 30.0,),
                onTap: () {
              ...
              ListTile(
                ...
                title: Text('state-scopedModel',textAlign: TextAlign.center,),
                trailing: Icon(Icons.radio,color: Colors.black,size: 30.0,),
                onTap: () {
                    Navigator.pop(context);
              ...
              ListTile(
                ...
                title: Text('stream',textAlign: TextAlign.center,),
                trailing: Icon(Icons.offline_bolt,color: Colors.blueGrey,size: 30.0,),
                onTap: () {
                   Navigator.pop(context);
              ...
              ListTile(
                ...
                title: Text('stream_controller',textAlign: TextAlign.center,),
                trailing: Icon(Icons.unarchive,color: Colors.purple,size: 30.0,),
                onTap: (){
                  Navigator.pop(context);
